...
class GiftsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post gifts_url, params: { gift: { link_gift: @gift.link_gift, name_gift: @gift.name_gift, price_gift: @gift.price_gift, user_id: @gift.user_id } }
    end
  ...
  test "should update gift" do
    patch gift_url(@gift), params: { gift: { link_gift: @gift.link_gift, name_gift: @gift.name_gift, price_gift: @gift.price_gift, user_id: @gift.user_id } }
